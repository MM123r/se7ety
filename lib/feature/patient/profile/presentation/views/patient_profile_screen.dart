...
import 'package:se7ety_123/feature/patient/profile/presentation/views/edit_patient_profile.dart';
import 'package:se7ety_123/feature/patient/profile/presentation/widget/appointment_history.dart';
import 'package:se7ety_123/feature/patient/search/widget/tile_widget.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              pushTO(context, const EditPatientProfile());
            },
          ),
        ],
      ),
